...
class PembeliController extends Controller
{
    public function index()
    {
        ...
        if (Auth::user()->role == 'pembeli') {
            // Ambil konser dengan status 'setuju'
            $dataKonser = Konser::where('status', 'setuju')->get();

            // Hitung jumlah tiket yang terbeli untuk setiap konser
            ...
            // Tampilkan halaman untuk pembeli
            return view('pembeli.beranda', $data);
        } else {
            // Jika bukan pembeli, redirect atau tampilkan pesan error
